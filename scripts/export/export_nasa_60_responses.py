...
使用例:
  python -m scripts.export.export_nasa_60_responses
  python -m scripts.export.export_nasa_60_responses --format long
"""
...
PAGE_SIZE = 1000
DEFAULT_OUTPUT = "data/exports/nasa_task_60_results.csv"
DIMENSION_ORDER = (
