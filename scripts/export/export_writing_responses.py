...
使用例:
  python -m scripts.export.export_writing_responses
  python -m scripts.export.export_writing_responses --format long
"""
...
PAGE_SIZE = 1000
DEFAULT_OUTPUT = "data/exports/writing_responses.csv"
...
def main() -> None:
    ...
    params: dict[str, Any] = {
        "select": (
            ...
            "completed_at,total_duration_sec,total_answer_duration_sec,total_char_count,"
            "created_at,writing_responses(*)"
        ),
    ...
    endpoint = f"{base_url.rstrip('/')}/rest/v1/writing_submissions"
