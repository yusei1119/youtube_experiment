...
DEFAULT_INPUT_90 = Path(
    "data/post_survey/実験後アンケート_ex1_2026_07（回答） - フォームの回答 1.csv"
)
DEFAULT_INPUT_60 = Path(
    "data/post_survey/実験後アンケート_ex2_time_05_2026_07（回答） - フォームの回答 1.csv"
)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=Path("analysis_runs/individual/post_survey"),
